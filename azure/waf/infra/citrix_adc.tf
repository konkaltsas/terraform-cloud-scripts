resource "azurerm_public_ip" "terraform-adc-management-public-ip" {
  name                = "tf-adc-management-public-ip"
...
resource "azurerm_network_interface" "terraform-adc-management-interface" {
  name                = "tf-adc-management-interface"
  location            = var.location
  resource_group_name = azurerm_resource_group.terraform-resource-group.name
...
resource "azurerm_virtual_machine" "terraform-adc-machine" {
  ...
  storage_image_reference {
    publisher = "citrix"
    offer     = "netscalervpx-131" #netscalervpx-130
    sku       = "netscalerbyol" #netscalervpxexpress
    version   = "latest"
  }

  plan {
    name      = "netscalerbyol" #netscalervpxexpress
    publisher = "citrix"
    product   = "netscalervpx-131" #netscalervpx-130-131
  }
